...
```
repo init -u https://github.com/Project-Awaken-Twelve/android_manifest -b 12
```
&nbsp; &nbsp; &nbsp; To save more time and space, you can do a shallow clone using

```
repo init --depth=1 -u https://github.com/Project-Awaken-Twelve/android_manifest -b 12
```
